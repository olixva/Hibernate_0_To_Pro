...
public class FunctionsTest {
    ...
    void coalesce() {
        ...
        // Si no hay fullName, se muestra el email (coalesce)
        String jpql = """ 
    ...
    void size() {
        ...
        // Size cuenta el número de elementos en la colección
        String jpql = """
                select e.id as id,
    ...
    void upperLower() {
        ...
        // Poner en mayuscula o minuscula
        String jpql = """
                select e.id as id,
    ...
    void replace() {
        ...
        // Primer parametro de donde vamos a remplazar
        // Segundo parametro lo que vamos a remplazar
        // Tercer parametro por lo que vamos a remplazar
        String hql = """
                select e.id as id,
