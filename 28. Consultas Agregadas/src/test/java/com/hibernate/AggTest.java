...
public class AggTest {
    ...
    void max2() {
        ...
        // Se busca el que al sumar esos campos sea MAX
    ...
    void multipleAggs() {
        ...
        Tuple results = session.createQuery(jpql, Tuple.class).getSingleResult();

        System.out.println("Max salary: " + results.get(0));
        System.out.println("Max bonus: " + results.get(1));
        System.out.println("Min salary: " + results.get(2));
        System.out.println("Min bonus: " + results.get(3));
    }
